...
function buildSubs(a: ArticleData): SubQuestion[] {
  return [
    { key: 'length',    label: '記事の文字数',     hint: '〜200000', truth: a.articleLength,       unit: 'バイト', defaultGuess: 20000 },
...
<template>
  <ModeLayout mode-name="逆引き型" short-name="E モード" emoji="🔄" theme="rose" gradient="from-rose-500 to-pink-600">
    <GenrePicker
      v-if="!started"
      mode-name="E モード"
    ...
    <template v-else>
      ...
      <p class="text-sm text-slate-600">
        記事のタイトルとカテゴリだけを見て、その記事の数値的な特徴を予測してください。
      </p>
