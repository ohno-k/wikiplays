    ...
    <div class="glass-card overflow-hidden">
      ...
      <div class="p-5 space-y-3">
        ...
        <div class="space-y-2 text-sm">
          ...
          <div>
            <span class="font-bold">記事の知名度:</span> 出題前に <span class="text-blue-700 font-bold">常識レベル 〜 超マニアック</span> の 5 段階 (または おまかせ) を選べます。
            知名度は Wikipedia での閲覧数 (直近 60 日の 1 日平均) を基準にした絶対評価で、ジャンルによって基準は変わりません。
            「常識レベル」は誰でも知っている題材だけが対象です (在庫が足りないときは近い段階の記事で補います)。
            B〜E モードでも同じ選択が使えます。
          </div>
          <div>
